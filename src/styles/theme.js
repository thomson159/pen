...
export const theme = (darkMode) => ({
  ...
  heroBG: darkMode
    ? "radial-gradient(76.02% 75.41% at 1.84% 0%, #B8860B 0%, #021d43 100%)"
  ...
  shadowColor: darkMode ? "#000" : "#FFE135",
  ...
  colors: {
    ...
    link: darkMode ? "#FFE135" : "#B8860B",
    invertedLink: darkMode ? "#FFE135" : "#B8860B",
  },
